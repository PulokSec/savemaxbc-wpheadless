...
export default function ApartmentSaleBanner(props: MyProps) {
  const {
    bannerData,
    headerData,
    settingsData,
      ...
      <div className='mt-20 flex flex-col items-center justify-center md:mt-40 lg:mt-60'>
        <div className='py-16'>
          <div className='flex max-w-[1200px] flex-col items-center justify-center px-5 lg:px-10'>
            <p className='w-full text-center text-xl font-bold uppercase leading-6 text-white md:text-4xl lg:text-6xl lg:leading-[66px]'>
              {bannerData?.bannerHeading}
            </p>
            {bannerData?.bannerDescription && (
              <div
                className='mt-8 text-center text-lg font-semibold text-white md:text-xl lg:text-3xl'
