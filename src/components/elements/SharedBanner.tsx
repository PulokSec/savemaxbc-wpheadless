...
export default function SharedBanner(props: MyProps) {
  ...
  return (
    ...
    >
      ...
      <div className='mt-20 md:mt-40 flex flex-col items-center justify-center lg:mt-60'>
        <div className='py-16'>
        ...
        {topTitle && topDesc ? (
          <div className=' container relative mx-auto mt-4 md:mt-40 w-[80%] rounded-b-xl bg-white px-5 py-3 text-center shadow-md lg:mt-[18%] '>
            <div
          ...
          <div className='container relative mx-auto w-[80%] rounded-b-xl bg-white px-5 py-3 text-center shadow-md '>
            ...
            <div className=''>
              ...
              <div className='mt-4 mb-2 lg:my-2 flex items-center justify-center'>
                <a
                  href='/contact-us'
                  className='text-uppercase rounded-xl border border-solid bg-[#061632] px-2 py-1 text-xs font-semibold text-white shadow-sm hover:border-[#061632] hover:bg-white hover:text-black focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#061632] md:px-3.5 md:py-2.5 md:text-lg'
                >
        ...
        {usingFor === 'seller' && (
          <div className='container relative mx-auto mt-[20%] md:mt-[40%] flex w-[80%] flex-col items-center justify-center rounded-b-xl bg-white px-5 py-3 text-center shadow-md lg:mt-[18%] lg:py-10'>
