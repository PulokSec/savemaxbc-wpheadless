...
export default function AboutBanner(props: MyProps) {
  ...
  return (
    <div
      className='relative h-[60vh] w-full bg-[length:100%_60vh] bg-center bg-no-repeat md:bg-[length:100%_100vh] lg:h-[100vh]'
      style={{
      ...
      <div className='mt-40 flex flex-col items-center justify-center lg:mt-60'>
        <div className='py-5 lg:py-10'>
          <div className='flex w-full flex-col items-center justify-center px-5 lg:px-10'>
            <p className='w-full text-center text-2xl font-bold uppercase leading-5 text-white md:text-3xl lg:text-7xl'>
