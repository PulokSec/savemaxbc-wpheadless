...
const HomeBuyingProcess = (props: MyProps) => {
  ...
  return (
    <div>
      ...
      <div
        className={` relative mt-10 p-10 pb-0 pt-[300px] text-white lg:hidden `}
      >
        <div className='mx-auto mb-20 max-w-[1250px] pt-40 text-center text-black'>
        ...
        <div className=' mx-auto max-w-[1250px] pb-32'>
          <div className=''>
                  ...
                  return (
                    <div key={index}>
                      ...
                      <div className='mt-5'>
                        ...
                        <div
                          className='text-[12px] text-black mb-2'
                          dangerouslySetInnerHTML={{
                            __html: item?.description,
                          }}
                        ></div>
        ...
        <div
          className='absolute bottom-[200px] left-1/2 mx-auto w-full  max-w-[1250px] -translate-x-1/2 -translate-y-1/2 transform p-3 text-center '
          dangerouslySetInnerHTML={{
            __html: featuredData?.bottomFeatureDescription,
          }}
        ></div>
