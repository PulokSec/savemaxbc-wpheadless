...
export default function EnsureSection(props: MyProps) {
  ...
  return (
    <section className='min-h-screen overflow-x-hidden bg-[url("http://savemaxheadlessdemo-com.us.webmyway.ca/wp-content/uploads/2023/10/ensure-highest-level-of-services.png")] bg-cover bg-center bg-no-repeat md:pt-[10%]'>
      ...
      <div className='mt-20 grid grid-cols-12 items-center justify-center gap-4 md:flex'>
        <div className='col-span-12 ml-5 flex h-[300px] w-[350px] flex-col items-center justify-center bg-[url("http://savemaxheadlessdemo-com.us.webmyway.ca/wp-content/uploads/2023/10/lower-middle-invest-in-our-realtors.png")] bg-cover bg-no-repeat px-5 md:col-start-2 md:ml-0 md:h-[300px] md:w-[270px]'>
