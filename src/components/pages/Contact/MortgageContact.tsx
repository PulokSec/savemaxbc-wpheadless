...
const MortgageContact = (props: Props) => {
  ...
  return (
    <div className='mx-auto flex max-w-[1400px] flex-col items-center justify-center gap-5 p-5 pb-10 md:flex-row lg:gap-10'>
      ...
      <div className='mx-auto md:w-1/2'>
        ...
        >
          <div className='relative mb-6' data-te-input-wrapper-init>
            <input
              ...
              name='name'
              id='name'
              className='w-full rounded border border-gray-400  text-[18px] placeholder:text-[14px] focus:border focus:border-[#061632] focus:outline-none md:w-[400px]'
              placeholder='Name'
              required
            />
          </div>
          ...
          <button
            ...
            className=' w-full rounded border border-gray-400 bg-[#061632]  py-1.5 text-[18px] text-white placeholder:text-[14px] hover:bg-white hover:text-[#061632] focus:border md:w-[400px]'
          >
            Send Message
          </button>
        </form>
        {alert && success && (
          <div
            className='mt-5 flex w-full items-center rounded-lg border border-green-300 bg-green-50 p-4 text-sm text-green-800 md:w-[400px]'
            role='alert'
          >
            <svg
        ...
        {alert && !success && (
          <div
            className='mt-5 flex w-full items-center rounded-lg border bg-red-300 p-4 text-sm text-red-700 md:w-[400px]'
            role='alert'
          >
            <svg
              xmlns='http://www.w3.org/2000/svg'
...
export default MortgageContact;
