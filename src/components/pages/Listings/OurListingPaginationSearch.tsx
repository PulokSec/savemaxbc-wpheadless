...
export default function OurListingPaginationSearch(props: MyProps) {
            ...
            {allPosts?.map((post: any) => {
              return (
                <Link
                  ...
                  className='card2-width mx-auto flex h-[510px] cursor-pointer flex-col justify-start overflow-hidden rounded-lg bg-white hover:shadow-2xl hover:shadow-slate-800 md:h-[500px]'
